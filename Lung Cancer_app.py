...
if page == "About":
    ...
    symptom_score = st.slider("SYMPTOM SCORE", 0, 10, 5, SYMPTOM_SCORE, disabled=True) # ✅ Auto-Updating Sliders
    lifestyle_score = st.slider("LIFESTYLE SCORE", 0, 5, 2, LIFESTYLE_SCORE, disabled=True)
